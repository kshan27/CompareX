    ...
    return (
        <form class="items-start place-items-start max-w-md mx-auto">
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block w-full p-3 ps-10 text-sm text-gray-700 border border-gray-300 rounded-lg bg-white focus:ring-gray-500 focus:border-grey-500" placeholder="What can we help you find ?" required />
                {/* <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required /> */}
                <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-button-color-red rounded-e-lg border border-white-color focus:ring-4 focus:outline-none focus:ring-grey-300 dark:bg-white-600 dark:hover:bg-white-700 dark:focus:ring-white-800">
                    Search
                </button>
            </div>
        </form>
